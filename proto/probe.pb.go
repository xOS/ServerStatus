...
var file_proto_probe_proto_rawDesc = []byte{
	...
	0x65, 0x64, 0x32, 0xa3, 0x01, 0x0a, 0x0c, 0x50, 0x72, 0x6f, 0x62, 0x65, 0x53, 0x65, 0x72, 0x76,
...
var file_proto_probe_proto_depIdxs = []int32{
	...
	0, // 2: proto.ProbeService.RequestTask:input_type -> proto.Host
	4, // 3: proto.ProbeService.ReportSystemState:output_type -> proto.Receipt
	4, // 4: proto.ProbeService.ReportSystemInfo:output_type -> proto.Receipt
	2, // 5: proto.ProbeService.RequestTask:output_type -> proto.Task
